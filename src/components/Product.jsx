const Product = () => {
    return (
        <div>
            <h2 className="text-2xl font-semibold my-4 text-center pb-8">Hot deals</h2>
            <section>
                <div className="mx-auto grid max-w-6xl  grid-cols-1 gap-6 p-15 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
